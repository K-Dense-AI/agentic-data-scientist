...
# Model configuration
DEFAULT_MODEL_NAME = os.getenv("DEFAULT_MODEL", "google/gemini-3.5-flash")
REVIEW_MODEL_NAME = os.getenv("REVIEW_MODEL", "google/gemini-3.5-flash")
CODING_MODEL_NAME = os.getenv("CODING_MODEL", "claude-opus-4-8")
